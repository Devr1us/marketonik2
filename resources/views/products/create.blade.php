...
<div class="mx-auto max-w-2xl">
    <div class="flex flex-wrap items-end justify-between gap-4">
        ...
        <a href="{{ $backRoute }}" class="text-sm font-semibold text-zinc-500 hover:text-zinc-300">← Kembali</a>
    </div>
    ...
    <form class="mt-8 space-y-5 rounded-2xl border border-white/10 bg-zinc-900/40 p-6" method="post" action="{{ $storeRoute }}" enctype="multipart/form-data">
        ...
        <div>
            ...
            <p class="mt-0.5 text-[11px] text-zinc-600">JPEG, PNG, WebP, atau GIF — maks. 5 MB.</p>
        ...
        <button type="submit" class="w-full rounded-xl bg-gradient-to-r from-amber-400 to-amber-600 py-3 text-sm font-bold text-zinc-950 hover:brightness-110">Publikasikan</button>
    </form>
</div>
