...
<div class="mx-auto max-w-lg py-6 md:py-16">
    ...
    <div id="panel-daftar" class="mt-8 hidden rounded-2xl border border-white/10 bg-zinc-900/40 p-6 shadow-2xl shadow-black/40 backdrop-blur">
        ...
        <p class="mt-1 text-xs text-zinc-500">Demo: sandi tidak diverifikasi ketat.</p>
        <form class="mt-6 space-y-4" method="post" action="{{ route('auth.register') }}">
            ...
            <button type="submit" class="w-full rounded-xl bg-gradient-to-r from-amber-400 to-amber-600 py-3 text-sm font-bold text-zinc-950 shadow-lg shadow-amber-500/25 hover:brightness-110">Daftar & masuk toko</button>
        </form>
    </div>
    ...
    <div id="panel-masuk" class="mt-8 rounded-2xl border border-white/10 bg-zinc-900/40 p-6 shadow-2xl shadow-black/40 backdrop-blur">
        ...
        <p class="mt-1 text-xs text-zinc-500">Demo: cukup username yang sudah terdaftar — password diabaikan.</p>
        <form class="mt-6 space-y-4" method="post" action="{{ route('auth.login') }}">
            ...
            <button type="submit" class="w-full rounded-xl border border-amber-500/40 bg-amber-500/10 py-3 text-sm font-bold text-amber-100 hover:bg-amber-500/20">Masuk ke toko</button>
        </form>
    </div>
</div>
