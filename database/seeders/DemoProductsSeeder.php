...
class DemoProductsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Gambar relevan per produk (sesuai urutan $templates)
        $imageUrls = [
            'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=800', // Smart TV 4K
            'https://images.unsplash.com/photo-1545454675-3531b543be5d?w=800', // Soundbar
            'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800', // Kulkas
            'https://images.unsplash.com/photo-1626806787461-102c1bfaaea1?w=800', // Mesin Cuci
            'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800', // AC Split
            ...
            'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800', // Smartphone
            'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800', // Smartwatch
            'https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=800', // Earbuds
            ...
            'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=800', // Mouse Gaming
            'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', // Router WiFi
            'https://images.unsplash.com/photo-1601737487795-dab272f52420?w=800', // NAS
            'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=800', // Power Station
            'https://images.unsplash.com/photo-1585515320310-259814833e62?w=800', // Air Fryer
            'https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=800', // Microwave
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // Setrika Uap
            ...
            'https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=800', // Proyektor
            'https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=800', // Power Strip
            'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=800', // UPS
            'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800', // Kipas Tower
            'https://images.unsplash.com/photo-1585515320310-259814833e62?w=800', // Humidifier
            'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=800', // Power Bank
            'https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=800', // Charger GaN
            'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=800', // SSD NVMe
            'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=800', // RAM DDR5
            'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800', // GPU Desktop
            'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800', // Headset Gaming
            'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=800', // Webcam 4K
            'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=800', // Mic USB
            'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800', // Mixer Audio
            'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=800', // Speaker Bluetooth
            'https://images.unsplash.com/photo-1545454675-3531b543be5d?w=800', // Hi-Fi Amplifier
            'https://images.unsplash.com/photo-1461360370896-922624d12aa1?w=800', // Turntable Vinyl
            'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=800', // Blu-ray Player
            'https://images.unsplash.com/photo-1545454675-3531b543be5d?w=800', // AV Receiver
            'https://images.unsplash.com/photo-1559591937-abc8a8b8e6b4?w=800', // Electric Toothbrush
            'https://images.unsplash.com/photo-1522338242992-e1a54906a8da?w=800', // Hair Dryer
            'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800', // Electric Kettle
            'https://images.unsplash.com/photo-1585515320310-259814833e62?w=800', // Induction Cooktop
            'https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=800', // Rice Cooker
            'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800', // Water Purifier
            'https://images.unsplash.com/photo-1585515320310-259814833e62?w=800', // Air Purifier
            'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800', // Dehumidifier
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // Electric Scooter
            'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', // E-Bike
            'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800', // Dashcam
            'https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=800', // Car Charger
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // FM Transmitter
            'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', // Smart Door Lock
            'https://images.unsplash.com/photo-1557597774-9d273605dfa9?w=800', // IP Camera
            'https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=800', // Smart Plug
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // Smart Bulb
            'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800', // Electric Screwdriver
            ...
            'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800', // Studio Lights
            'https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=800', // Gimbal Smartphone
            'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=800', // Portable SSD
            ...
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // Sim Racing Wheel
            'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?w=800', // VR Headset
            'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800', // Handheld Gaming PC
            'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=800', // Mini PC
            'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', // Network Switch
            'https://images.unsplash.com/photo-1601737487795-dab272f52420?w=800', // NAS 2-bay
            'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800', // Electric Height Desk
            'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800', // Ergonomic Chair
            'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800', // Standing Desk Converter
            'https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=800', // USB-C Hub
            'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=800', // Bluetooth Trackpad
            'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=800', // Wireless Charging Pad
            'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800', // Smart Scale
            'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800', // Fitness Ring
            'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=800', // Portable Monitor OLED
            'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800', // Laser Engraver
            'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800', // 3D Printer
            'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800', // Soldering Station
            'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=800', // Oscilloscope
            'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=800', // Bench Power Supply
            'https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=800', // Component Storage
            'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800', // ESD Mat
            'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800', // Thermal Paste
            'https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=800', // Cable Management Box
            'https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=800', // Laptop Cooling Pad
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // RGB Light Strip
            'https://images.unsplash.com/photo-1585515320310-259814833e62?w=800', // Smart Thermostat
            'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', // Robot Window Cleaner
            'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800', // Portable AC
            'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800', // Mini Fridge
            'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800', // Wine Cooler
            'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800', // Espresso Machine
            'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800', // Bean Roaster
            'https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=800', // Sous Vide
            'https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=800', // Bread Maker
            'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800', // Ice Maker
            'https://images.unsplash.com/photo-1559591937-abc8a8b8e6b4?w=800', // Water Flosser
            'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800', // Massage Gun
            'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800', // Heated Blanket
            'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800', // Electric Blanket Throw
            'https://images.unsplash.com/photo-1585515320310-259814833e62?w=800', // Ceramic Heater
            'https://images.unsplash.com/photo-1585515320310-259814833e62?w=800', // Oil Radiator
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // Steam Iron Station
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // Garment Steamer
            ...
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // E-Bike Conversion Kit
            'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800', // Solar Panel
            'https://images.unsplash.com/photo-1601597111158-2fceff292cdc?w=800', // Power Inverter Car
            'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800', // Jump Starter
            'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800', // Tire Inflator
            'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800', // Car Vacuum
            'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800', // OBD2 Scanner
            'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800', // TPMS Sensors
            'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800', // Backup Camera
            'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800', // HUD Speed
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // E-Bike Battery Pack
            'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800', // E-Scooter Spare Tire
            ...
            'https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800', // Aquarium Heater
            'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800', // Auto Fish Feeder
            'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800', // LED Grow Light
            'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800', // Hydroponic Tower
        ];
